...
export const queryCode = `query FullQuery{root{showNewSection}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"showNewSection":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"showNewSection":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/6730/main/draft/logic?selected_field_path=root%3EshowNewSection","description":"Show the new featured section on homepage"}};
...
export type Root = {
  /**
   * Show the new featured section on homepage
   */
  showNewSection: boolean;
}

const rootFallback = {showNewSection:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * Show the new featured section on homepage
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/6730/main/draft/logic?selected_field_path=root%3EshowNewSection})
   */
  showNewSection({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("showNewSection", { fieldArguments: args });
...
const sourceFallback = {root:{showNewSection:false}};
